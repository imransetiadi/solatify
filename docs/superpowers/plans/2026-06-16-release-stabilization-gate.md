...
Run:
```bash
/Users/imboyy/development/flutter/bin/flutter analyze --no-pub
```
...
Run:
```bash
/Users/imboyy/development/flutter/bin/flutter test --no-pub
```
...
```bash
/Users/imboyy/development/flutter/bin/flutter test --no-pub test/notification_scheduler_test.dart
```
...
Run:
```bash
/Users/imboyy/development/flutter/bin/flutter build apk --release
```
...
Run:
```bash
/Users/imboyy/development/flutter/bin/flutter build appbundle --release
```
...
Run:
```bash
/Users/imboyy/development/flutter/bin/flutter build ios --release --no-codesign
```
